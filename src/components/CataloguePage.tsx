      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Comprehensive range of MALDI-TOF MS calibration
          ...
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-3">
                {productData.find(
                  (section) =>
                    section.section === selectedCategory,
                )?.text &&
                  stripHtml(
                    productData.find(
                      (section) =>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm text-gray-600">
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  • Click on any product to view detailed
                  specifications
                </li>
                <li>
                  • Use "Request Quote" button to send email
                  inquiry
                </li>
                <li>
                  • Receive quotation and availability
                  confirmation
                </li>
                <li>
                  • Complete order via direct bank transfer
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  • Net 30 payment terms for established
                  customers
                </li>
