...
${formData.message}`;
    ...
    const subject = formData.subject || `${formData.inquiryType} Inquiry from ${formData.name}`;
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl mb-4 text-gray-900">Contact Us</h1>
          <p className="text-xl text-gray-600">
            Get in touch with our team for product inquiries, technical support, or general questions
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-6">
                  We're here to help with your MALDI-TOF calibration needs. Whether you need technical 
                  support, product information, or custom solutions, our team of experts is ready to assist you.
                </p>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-3">
                  <Button 
                    ...
                    onClick={() => window.location.href = 'mailto:sales@laserbiolabs.com?subject=Product Inquiry'}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="justify-start"
                    onClick={() => window.location.href = 'mailto:support@laserbiolabs.com?subject=Technical Support'}
                  >
                    <Mail className="h-4 w-4 mr-2" />
                    Technical Support
                  </Button>
                  <Button 
                    variant="outline" 
                    className="justify-start"
                    onClick={() => window.location.href = 'mailto:orders@laserbiolabs.com?subject=Order Status'}
                  >
                    <Mail className="h-4 w-4 mr-2" />
                    Order Status
                  </Button>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-gray-500 mt-4">
                * Required fields. We typically respond to inquiries within 24 hours during business days.
              </p>
            </CardContent>
          </Card>
        </div>
